...
MESSAGE = "Khôi có ngu không ?! Khôi có biết training AI không ?!"
# =============================================
...
header_flags = {
    "reasoning": False,
    "chunk": False  # Hoặc 'call' tùy theo type agent bạn trả về
}
        ...
        for line in r.iter_lines():
            ...
            if line_str.startswith('data: '):
                try:
                    ...
                    elif event_type in ["chunk", "message", "Rolecall", "text"]:  # Tùy vào type bạn yield từ server
